...
public class PersonSkillService {
    ...
    public List<PersonSkill> list(Integer villageId) {
        if (villageId != null) {
    ...
    public List<PersonSkill> listByPerson(Integer personId) {
        return repo.findByPersonId(personId);
    }

    public ResponseEntity<?> add(PersonSkill e) {
        try {
    ...
    public ResponseEntity<?> edit(PersonSkill e) {
        try {
