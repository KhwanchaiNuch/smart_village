                ...
                {issuesSummary.pendingList.map((issue) => {
                  ...
                  return (
                    <div key={issue.id} className="flex items-start gap-3 p-2.5 rounded-xl bg-gray-50 dark:bg-gray-800/50">
                      <div className="w-8 h-8 rounded-full bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center text-sm flex-shrink-0"><span className="text-xs font-bold text-current">!</span></div>
                      <div className="min-w-0 flex-1">
